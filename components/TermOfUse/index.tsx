            ...
            <div>
              <TabPanel value={value} index={0}>
                ...
                <div className="font-light ">
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    Please read these Terms of Use carefully as it contains
                    legal and regulatory information relevant to the content of
                    this website https://www.base-am.com (the “Website”). By
                    proceeding further, you indicate that you accept the terms
                    and conditions below and agree to abide by them. If you do
                ...
                <div className="space-y-4 font-light">
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    ...
                    activities in Hong Kong, for and on behalf of, or in respect
                    of, various investment entities managed or advised by BASE
                    (the “Funds”). The Website is not directed to any person in
                    any jurisdiction where the publication or availability of
                    the Website is prohibited or by reason of that person's
                    nationality, residence, domicile or otherwise, or if BASE
                    would become subject to licence or registration regulations
                    of that jurisdiction. Persons in respect of whom such
                    prohibitions apply must not access this Website.
                  </p>
                </div>
                ...
                <div className="space-y-4 font-light">
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    ...
                    this Website have been authorised by any regulatory
                    authority in Hong Kong. Any investment or investment
                    activity to which this Website relates is available only to
                    and will be engaged only with Professional Investors. Any
                    person who is not a Professional Investor should not act or
                    rely on this Website or any of its content.
                  </p>
                </div>
                ...
                <div className="space-y-4 font-light">
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    This Website has not been reviewed by the SFC and is
                    provided to you on the basis that you are a Professional
                    Investor. By accessing this Website, you acknowledge and
                    agree that this information is provided for your use only
                    and that you will not distribute or otherwise make this
                    material available to a person who is not a Professional
                    Investor.
                  </p>

                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    No unauthorised person should attempt to gain access to any
                    restricted area of the Website. We disclaim all liability
                    for any loss a user may suffer from access to the Website by
                ...
                <div className="space-y-4 font-light">
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    The value of investments and the income generated may go
                    down as well as up, and the investors may not get back the
                    amount originally invested. Past performance is not a
                    reliable indicator of future performance, whilst any
                    forecast, projections and simulations contained herein
                    should not be relied upon as an indication of future
                    results. Additional risks are associated with investments in
                    emerging or developing markets, including virtual assets
                    (the “Investments”). Investments carry substantial and
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    ...
                    forecasts of future events. However, these statements are
                    not guarantees of future performance or events and involve
                    risks and uncertainties. Actual results may differ
                    materially from those described in such forward-looking
                    statements. This may be a result of various factors. We are
                    not obligated to update the information or forward-looking
                    statements contained herein, nor are we obligated to update
                    the reasons why actual results could differ from those
                    projected in the forward-looking statements.
                  </p>
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    The users of this Website should seek advice from
                    independent financial, legal, or tax professionals before
                    making any investment decisions. The information herein
                    should not be construed as general or specific investment,
                    legal, tax or accounting advice of any kind. Any investment
                    decisions should be based on the terms described in the
                    relevant offering document, subscription documents,
                    constitutional documents and/or any other relevant document
                    as appropriate (the “Offering Document”). Any investment
                    will be subject to the terms set out in its Offering
                    Document and all applicable laws and regulations. There is
                    always a risk that any capital invested could incur a
                    substantial or complete loss.
                  </p>
                </div>
                ...
                <div className="space-y-4 font-light">
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    Please do not make any investment decisions by solely
                    relying on the information in this document. The contents of
                    this Website are believed to be based on reliable sources,
                    but we cannot guarantee the accuracy or completeness of
                    third-party information. We shall not be required to remove
                    any outdated information from this Website or to mark it as
                    outdated expressly. Even if we are explicitly notified of
                    the possibility or likelihood of such losses, we will not be
                    responsible for any direct, indirect, special, or
                    consequential damages that result from your utilisation of
                    the information on this Website or any other hyper-linking
                ...
                <div className="space-y-4 font-light">
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    This Website does not constitute any public offers,
                    soliciting or recommendations to buy or sell any securities
                    or financial instruments, effect any transactions, or
                    conclude any legal act of any kind whatsoever. If the
                    information and views offered on this Website are classified
                    as constituting a public offer under the legislation of the
                    jurisdiction from which you wish to access it, you must not
                    access the Website.
                  </p>
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    ...
                    such offer or solicitation, purchase or sale would be
                    illegal under the securities, insurance or other laws of
                    such jurisdiction. You should obtain relevant and specific
                ...
                <div className="space-y-4 font-light">
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    ...
                    reproduced, distributed or transmitted to any other person
                    or incorporated in any way into another database, document
                    or other materials without our permission. Nothing on this
                    Website should be considered as granting any licence or
                    right under any trademark, copyright, or other intellectual
                    property rights of us or any third party.
                  </p>
                </div>
                ...
                <div className="space-y-4 font-light">
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    ...
                    that do not refer to our own website material are not run
                    and have not been reviewed by us. We take no responsibility
                    for the content of any other websites or pages that are
                    linked to or linking from this Website. Such addresses or
                    hyperlinks are provided solely for your convenience and
                    information and are absolutely beyond our control. Accessing
                    such websites or following such links to any other websites
                    or pages shall be at your own risk. We do not assume any
                    responsibility for the accuracy, completeness or legality of
                    the contents of such websites, or for any offers or services
                    contained therein.
                  </p>
                </div>
                ...
                <div className="space-y-4 font-light">
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    ...
                    provide to us through this Website seriously. A “cookie” is
                    a piece of information stored on your computer’s hard disk
                    by the web server. By continuing to use this Website, you
                    agree to our terms and conditions, which will activate the
                    cookie feature. This session-based cookie makes it easier
                    for you to navigate the Website without having to re-agree
                    to the terms and conditions each time. Website cookies don’t
                    transmit personal information and expire once you close your
                    browser. Cookies are used for no other purpose. You are not
                    required to accept a cookie offered to you, and you can
                    modify your settings to reject cookies.
                  </p>
                ...
                <div className="space-y-4 font-light">
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    The personal information we collect from you on this
                    website, such as your name, address, phone number and email
                    address details submitted during our customer registration
                    procedures. We use this information to fulfil our regulatory
                    obligations and legitimate business interests for our own
                    internal purposes. By submitting personal data and agreeing
                    to these terms and conditions, you consent to such
                    information being processed for the aforementioned purposes.
                    You also agree that we have the right to use and store such
                    data on our internal systems and transfer it to our
                    associated entities. Please contact us if you have any
                    questions regarding how we will utilise your information.
                  </p>
                </div>
                ...
                <div className="space-y-4 font-light">
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    ...
                    Administrative Region, and any disputes arising from your
                    use of this website will be handled exclusively by courts in
                    that region.
                  </p>
                </div>
                ...
                <div className="space-y-4 font-light">
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    ...
                    information on the Website at any time, with or without
                    prior notice. You agree to review these terms and conditions
                    on a regular basis, and your continued usage of the Website
                    implies that you accept such modifications.
                  </p>
                </div>
                ...
                <div className="space-y-4 font-light">
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    ...
                    unenforceable in a specific jurisdiction, that provision
                    will only be ineffective in that jurisdiction to the extent
                    of the prohibition or unenforceability. This does not
                    invalidate the remainder of these terms and conditions nor
                    affect the validity or enforceability of that provision in
                ...
                <div className="space-y-4 mb-7 font-light">
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    ...
                    terms. You agree to indemnify, defend and hold harmless us
                    and our agents, employees and third-party sources from and
                    ...
                    use of the Website; (b) breaches of these terms by you; or
                    (c) violation of any applicable law, statute, ordinance,
              ...
              <TabPanel value={value} index={1}>
                ...
                <div className="font-light ">
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    ...
                    this Privacy Notice, “BASE”, “we”, “us”, and “our” means
                    Base Asset Management Limited.
                  </p>

                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    “Personal data” refers to any information that can be used
                    to identify you, such as your name, contact details,
                    identification number, account number and balance,
                    transaction history or online identifiers such as your IP
                    address. Personal data does not include data from which you
                    can no longer be identified such as anonymised aggregate
                    data.
                  </p>
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    ...
                    Notice or how we handle your personal data, please contact
                    us at info@base-am.com.
                  </p>
                </div>
                ...
                <div className="space-y-4 mb-7 font-light">
                  ...
                  <ul className="list-disc ml-7">
                    ...
                    <ul className="list-disc ml-7">
                      <li className="text-justify font-normal text-[16px] leading-[26px]">
                        your contact details, such as email address(es),
                        telephone numbers and postal address(es);
                      </li>
                      <li className="text-justify font-normal text-[16px] leading-[26px]">
                      ...
                      <li className="text-justify font-normal text-[16px] leading-[26px]">
                        ...
                        type and operating system information (note that we do
                        not attempt to identify individuals using this
                        information);
                      </li>
                    </ul>
                    ...
                    <ul className="list-disc ml-7">
                      ...
                      <li className="text-justify font-normal text-[16px] leading-[26px]">
                        other information which you provide in your
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    ...
                    This type of data is originated from your personal but
                    cannot be used to identify you specifically. For example, we
                    may compute the percentage of our users who are interested
                    in a certain product type by combining your browsing
                    information with other data. However, if we combine or link
                    aggregated data with your personal data so that it can be
                    used to identify you, we consider the combined data to be
                    personal data under this Privacy Notice and will use it in
                    accordance with this notice.
                  </p>
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    If we are required by law to do so, or if we believe that it
                    is necessary to protect our rights and/or comply with
                    judicial or regulatory proceedings, a court order or other
                    legal process, we may collect your personal data without
                ...
                <div className="space-y-4 mb-7 font-light">
                  ...
                  <ul className="list-disc ml-7">
                    <li className="text-justify font-normal text-[16px] leading-[26px]">
                      when you submit your information on our Website through
                      our contact form;
                    </li>
                    <li className="text-justify font-normal text-[16px] leading-[26px]">
                      when you request literature or research information from
                      us;
                    </li>
                    <li className="text-justify font-normal text-[16px] leading-[26px]">
                    ...
                    <li className="text-justify font-normal text-[16px] leading-[26px]">
                      when you attend the events hosted or co-hosted by BASE;
                      and
                    </li>
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    We may also collect certain information when you interact
                    with our Website, such as your device type and browsing
                    actions and patterns. We collect this personal data through
                  ...
                  <ul className="list-disc ml-7">
                    ...
                    <li className="text-justify font-normal text-[16px] leading-[26px]">
                      the companies contracted by us to offer or market our
                      sales materials to you, such as our sales affiliates and
                      external partners;
                    </li>
                    <li className="text-justify font-normal text-[16px] leading-[26px]">
                      our marketing service provider may combine the data
                      provided on our Website by you with other publicly
                      available data about you, such as your social media
                      account information.
                    </li>
                  </ul>
                </div>
                ...
                <div className="space-y-4 mb-7 font-light">
                  ...
                  <ul className="list-disc ml-7">
                    ...
                    <li className="text-justify font-normal text-[16px] leading-[26px]">
                      ...
                      purposes, and for system support maintenance and hosting
                      of data in the event of business reorganisation or group
                ...
                <div className="space-y-4 mb-7 font-light">
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    ...
                    your personal data, as well as the potential risk of harm
                ...
                <div className="space-y-4 mb-7 font-light">
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    If you have given your consent for us to collect, process,
                    and transfer your personal data for a specific purpose, you
                    can withdraw that consent at any time. To withdraw your
                    consent, please contact us at info@base-am.com. Once we
                    receive notification of your withdrawn consent, we will no
                    longer process your information unless we have an
                    alternative legal basis for doing so.
                  </p>

                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    In order to protect your information and ensure that only
                    you have access to it, we may request specific details from
                    you. This is a security measure to guarantee that personal
                    data is not given to anyone who isn't allowed to receive it.
                    We strive to safeguard all information we collect from you,
                    but we cannot guarantee the security of any information you
                    submit to us.
                  </p>
                </div>
                ...
                <div className="space-y-4 mb-7 font-light">
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    We have the right to update this Privacy Notice without
                    prior notice at any time, and we will make an updated copy
                    of such Privacy Notice available on our Website.
                  </p>

                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    This Privacy Notice was intentionally written to be succinct
                    and transparent. It is not a comprehensive description of
                    all aspects of our data collection and usage. Please do not
              ...
              <TabPanel value={value} index={2}>
                ...
                <div className="space-y-4 mb-7 font-light">
                  ...
                  <ul className="list-disc ml-7">
                    <li className="text-justify font-normal text-[16px] leading-[26px]">
                      the internet domain and IP address from where you access
                      the Website;
                    </li>
                    <li className="text-justify font-normal text-[16px] leading-[26px]">
                ...
                <div className="space-y-4 mb-7 font-light">
                  ...
                  <ul className="list-disc ml-7">
                    ...
                    <p className="font-normal text-[16px] leading-[26px] text-justify">
                      ...
                      enable you to log into secure areas of our website. These
                      cookies will be deleted when you finish your session on
                      our website.
                    </p>
                    <li className="font-semibold italic">
                    ...
                    <p className="font-normal text-[16px] leading-[26px] text-justify">
                      These cookies allow us to recognise and count the number
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    ...
                    are controlled by third parties, such as social media APIs
                    and external website providers. These cookies are frequently
                    analytical/performance or targeting cookies. You should
                    refer to the third parties’ own cookie and privacy policies
                    to learn how they intend to use your data.
                  </p>
                  <p className="font-normal text-[16px] leading-[26px] text-justify">
                  ...
                  <ul className="list-disc ml-7">
                    ...
                    <li className="text-justify font-normal text-[16px] leading-[26px]">
                      ...
                      social media sharing purpose. For details of Twitter
                      cookies usage, please click{" "}
                ...
                <div className="space-y-4 mb-7 font-light">
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    ...
                    keep in mind that if you use your browser's settings to
                    block all cookies (including essential cookies), you may not
                    be able to access some or all of our Services. Click here to
                  ...
                  <p className="font-normal text-[16px] leading-[26px] my-2 text-justify">
                    ...
                    cookies from your device depend on which operating system
                    and web browser you use. Please keep in mind, however, that
              ...
              <TabPanel value={value} index={3}>
                  ...
                  <ul className="list-disc ml-7">
                    ...
                    <ul className="list-disc ml-7">
                      ...
                      <li className="text-justify font-normal text-[16px] leading-[26px]">
                        ...
                        outside Hong Kong and, if it is regulated under the law
                        of such place, is permitted to be operated under the law
                        of such place,
                      </li>
                    </ul>
                ...
                <div className="font-light ">
                  ...
                  <p className="font-normal text-[16px] leading-[26px] text-justify">
                    ...
                    to the Ordinance, the following persons are prescribed as
                    within the meaning of that definition for the purposes of
                    any provision of the Ordinance other than Schedule 5—
                  </p>
                  <ul className="list-disc ml-7">
                    <li className="text-justify font-normal text-[16px] leading-[26px]">
                ...
                <div className="font-light ">
                  ...
                  <p className="font-normal text-[16px] leading-[26px] text-justify">
                    A trust corporation specified for the purposes of section
                    3(a) is a trust corporation having been entrusted under one
                    or more trusts of which it acts as a trustee with total
                    assets of not less than $40 million at the relevant date or
                    as ascertained in accordance with section 8.
                  </p>
                </div>
                ...
                <div className="font-light ">
                  ...
                  <ul className="list-disc ml-7">
                    ...
                    <ul className="list-disc ml-7">
                      <li className="text-justify font-normal text-[16px] leading-[26px]">
                        the individual’s share of the portfolio as specified in
                        a written agreement among the account holders; or
                      </li>
                      <li className="text-justify font-normal text-[16px] leading-[26px]">
                  ...
                  <ul className="list-disc ml-7">
                    ...
                    <ul className="list-disc ml-7">
                      ...
                      <li className="text-justify font-normal text-[16px] leading-[26px]">
                        ...
                        professional investor in section 1 of Part 1 of Schedule
                        1 to the Ordinance; or
                      </li>
                    </ul>
                    <li className="text-justify font-normal text-[16px] leading-[26px]">
                ...
                <div className="font-light ">
                  ...
                  <p className="font-normal text-[16px] leading-[26px] text-justify">
                    A partnership specified for the purposes of section 3(d) is
                ...
                <div className="font-light ">
                  ...
                  <p className="font-normal text-[16px] leading-[26px] text-justify">
                    ...
                    individual, or the portfolio or total assets of a
                    corporation or partnership, are to be ascertained by
                    referring to any one or more of the following—
                  </p>
                  ...
                  <ul className="list-disc ml-7">
                    ...
                    <ul className="list-disc ml-7">
                      ...
                      <li className="text-justify font-normal text-[16px] leading-[26px]">
                        ...
                        corporation (whether on its own behalf or in respect of
                        a trust of which it acts as a trustee), individual,
                        corporation or partnership.
                      </li>
                    </ul>
                  </ul>
                  <p className="text-justify font-normal text-[16px] leading-[26px] my-5 mb-10">
                    *Under Section 2A of the PI Rules, “In these Rules, a
                    reference to an amount expressed in Hong Kong dollars
                    includes its equivalent in any foreign currency.”
                  </p>
                </div>
              </TabPanel>
            </div>
