...
import logo from "../public/img/banner/BAM_Pic3.gif";
import Footer from "components/footer";
import Header from "../components/ProcessHeader";
import SeeOurTeam from "components/SeeOurTeam";
      ...
      <div className="w-full bg-[#F5F5F5] flex flex-col justify-center items-center ">
        <div className="lg:px-[144px] px-[7%] max-w-[1440px] ">
          ...
          <div className="lg:max-w-[70%] font-normal	text-[18px] leading-[28px]">
            ...
            the short term, they can be inefficient and provide opportunities
            for active management. Our investment process is designed to take
            advantage of these inefficiencies and hence technical models are
