  ...
  return (
    <div className="w-full">
      <ThemeProvider theme={theme}>
        <Header />
        <div className="bg-[#CBC3BB] px-[144px]">
        ...
        <div className="bg-white px-[144px]">
          <div className="max-w-[1200px] m-0 m-auto py-[17px]">
            <h1 className="font-bold text-[18px] leading-[30px] text-[#CBC3BB]">
              About /<span className="font-semibold text-black"> Our Team</span>
            </h1>
          </div>
        </div>

        <div className="bg-[#F0F0F0] px-[144px]">
          <div className="max-w-[1200px] pt-[81px] pb-[90px] m-0 m-auto">
            <div className="lg:flex">
              <div className="relative lg:mr-10 pt-[25px] border-t-[6px] border-b-[1px] border-[#CBC3BB] flex-shrink-0 lg:w-[329px] flex flex-col">
                <span className="font-semibold lg:text-[20px] lg:leading-[30px] lg:text-[#E04403]">
                  Founder and Managing Partner
                </span>
                <span className="mt-1 font-extrabold pb-20 lg:text-[40px] lg:leading-[56px]">
                  Chris Leung
                </span>
                <div className="absolute bottom-[23px] font-light lg:text-[20px] lg:leading-[30px]">
                  <Image
                    src={linkedin}
                    alt="TheDifferentiator"
                    width={34}
              ...
              <div className="relative pt-[25px] border-t-[6px] border-b-[1px] border-[#CBC3BB] md:flex-grow pb-10">
                <p className="font-normal	lg:text-[16px]  lg:leading-[28px] lg:text-justify">
                ...
                <p className="font-normal	lg:text-[16px] mt-[16px] lg:leading-[28px] lg:text-justify">
            ...
            <div className="lg:flex lg:mt-[50px]">
              <div className="relative lg:mr-10 pt-[25px] border-t-[6px] border-b-[1px] border-[#CBC3BB] flex-shrink-0 lg:w-[329px] flex flex-col">
                <span className="font-semibold lg:text-[20px] lg:leading-[30px] lg:text-[#E04403]">
                  Managing Partner
                </span>
            ...
            <div className="lg:flex lg:mt-[50px]">
              <div className="relative lg:mr-10 pt-[25px] border-t-[6px] border-b-[1px] border-[#CBC3BB] flex-shrink-0 lg:w-[329px] flex flex-col">
                ...
                <span className="mt-1 font-extrabold pb-10 lg:text-[40px] lg:leading-[56px]">
                  Joe Law
                </span>
                <div className="absolute bottom-[23px] font-light lg:text-[20px] lg:leading-[30px]">
                  <Image
              ...
              <div className="relative pt-[25px] border-t-[6px] border-b-[1px] border-[#CBC3BB] md:flex-grow">
                <p className="font-normal	lg:text-[16px]  lg:leading-[28px] lg:text-justify">
            ...
            <div className="lg:flex mt-[50px]">
              <div className="relative lg:mr-10 pt-[25px] border-t-[6px] border-b-[1px] border-[#CBC3BB] flex-shrink-0 lg:w-[329px] flex flex-col">
                ...
                <span className="mt-1 font-extrabold pb-0 lg:text-[40px] lg:leading-[56px]">
                  Hill Chan
                </span>
              </div>
        ...
        <div className=" pb-[175px] bg-[#F0F0F0]">
          <a href="/our-philosophy">
            <div className="w-[278px] h-[90px] bg-[#00953B] flex justify-center float-right">
              <div className="self-center">
